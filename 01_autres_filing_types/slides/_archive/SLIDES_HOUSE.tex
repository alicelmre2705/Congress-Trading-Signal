...
% Tous les chiffres proviennent des tables versionnées 01_autres_filing_types/cache/tables/*.csv et de
...
\graphicspath{{figs/}}   % AUTONOME : toutes les images vivent dans 01_autres_filing_types/slides/figs/
