...
## 4. Chiffres de la donnée House (golden)
...
- **Table 12/12 champs** : ticker **85,3 %**, secteur GICS→ETF **83,2 %** (yfinance + repli LLM),
  `date_confidence` (95,3 % plausible sur les lignes OCR) → parité Sénat.
