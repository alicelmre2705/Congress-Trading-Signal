...
\multicolumn{2}{p{15.4cm}}{\footnotesize golden (\co{build_golden}/\co{check_golden} + Sénat) · reproductions (\co{test_schema}, \co{test_identity}, \co{test_amounts_tickers}, \co{test_senate_repro}, \co{test_vision_sha}, \co{test_tenure}, \co{test_incremental}, \co{test_crosscheck}) · \co{audit_metrics} · \co{smoke_digital} (obsolète) · \co{_apply_house_sector}} \\
\bottomrule
\end{longtable}}
