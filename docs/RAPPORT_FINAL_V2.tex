...
chambres} du Congrès sur sept ans (2020--2026). Le pipeline reconstruit \textbf{90\,483 lignes} brutes, soit
\textbf{89\,852 transactions uniques} après dédup cross-année des re-divulgations tardives~: \textbf{81\,607}
pour la \textbf{Chambre des représentants} (brut 81\,642 = 32\,676 électroniques + 48\,966 OCR) et
\textbf{8\,245} pour le \textbf{Sénat} (brut 8\,841 = 7\,161 électroniques + 1\,680 papier OCR). Chaque transaction est
rattachée à son auteur (\textbf{100\,\%} des lignes à la Chambre, \textbf{100\,\%} au Sénat) et enrichie
...
\node[step=houseC, text width=3.0cm] (hvis) at (-2.6,-5.0) {\textbf{OCR Claude Vision}\\\footnotesize redressée, lue en JSON\\[1pt]\textbf{\color{houseC}48\,966}};
...
\node[file, text width=12.6cm, fill=houseC!10, draw=coreC, line width=1pt] (fin) at (0,-10.7)
  {\textbf{TABLE FINALE} — \textbf{89\,852 uniques} (90\,483 lignes) · \co{06_\{ch\}_\{an\}_FINAL.csv} · 28 colonnes · \textbf{contrat 12 champs métier}};
...
La résolution rattache \textbf{100\,\%} des lignes de la Chambre (81\,642 / 81\,642) et \textbf{100\,\%}
de celles du Sénat~: toute ligne conservée porte un \co{bioguide_id}. Une \emph{seule} déclaration
manuscrite de 2023 a été \textbf{exclue du périmètre membres}~: celle d'une \textbf{collaboratrice de
commission} non-élue (Natalia~Henriquez, \emph{House Armed Services Committee}), identifiée en lisant le
PDF source (l'OCR avait lu « Ada~Norah Henriquez » et un district « PR00 » erronés~; les agents du Congrès
n'ont pas de \co{bioguide_id}). À la Chambre, \textbf{256}
identifiants pour \textbf{274} graphies~: l'écart, ce sont les variantes d'un même élu ramenées à un
...
32\,676 transactions électroniques et 48\,966 issues de l'OCR à la Chambre, 7\,161 et 1\,680 au Sénat — et
...
Au total, la piste scannée fournit \textbf{48\,966} lignes, très concentrées~: Rohit Khanna en représente à
...
\textbf{Sauf mention « par chambre » ou « par sous-corpus », tout porte sur l'ensemble des 89\,852
transactions finales uniques — électronique et OCR confondus, les deux chambres, 2020--2026.} Les quatre figures
...
Sénat, chacun en électronique et en OCR papier (Chambre électronique 32\,676~; Chambre OCR 48\,966~; Sénat
...
{\color{houseC}Chambre OCR} & 48\,966 & 83,1 & 81,0 & 8\,000 & 0,91 & 98,7 \\
...
appel API). \textbf{(a)--(d)~vues d'ensemble} sur les 89\,852 transactions finales uniques (électronique et OCR
...
La \textbf{couche données} décrite ici est livrée~: 89\,852 transactions uniques (90\,483 lignes brutes) extraites, identifiées,
...
% ============================ 10. CONCLUSION ============================
\section{Conclusion}
Sur deux chambres et sept ans, le pipeline reconstruit \textbf{90\,483} lignes (\textbf{89\,852} transactions uniques) à partir des
sources officielles, en traitant honnêtement les deux pistes (électronique déterministe \emph{et}
scannée par OCR Vision). Chaque ligne est identifiée (100 / 100\,\%), enrichie (table 12/12 sur les
...
2023 & 4\,161 & 6\,325 & 10\,486 & 100 & 1\,062 & 97 & 1\,159 & 30 \\
...
\midrule
\bfseries Tot. & \bfseries 32\,676 & \bfseries 48\,966 & \bfseries 81\,642 & \bfseries 256$^\ast$ & \bfseries 7\,161 & \bfseries 1\,680 & \bfseries 8\,841 & \bfseries 64$^\ast$\\
\bottomrule
\end{tabular}
\end{center}
...
\co{audit_metrics.py}~: les totaux, l'identité (\textbf{256} bioguides / 274 noms à la Chambre, \textbf{64} /
67 au Sénat~; \textbf{0} / 0 lignes sans bioguide) et le golden octet-à-octet (\textbf{125} fichiers Chambre,
\textbf{76} Sénat). \textbf{Total~: 90\,483 lignes brutes (89\,852 uniques après dédup cross-année).}}
...
{\color{houseC}Chambre OCR} & 48\,966 & 83,1 & 81,0 & 94,5 & 99,7 & 98,2 \\
