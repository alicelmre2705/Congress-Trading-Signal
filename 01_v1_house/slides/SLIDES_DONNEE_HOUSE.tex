...
\begin{frame}[plain]
  ...
  \colorbox{helec!8}{\parbox{0.84\textwidth}{\centering\footnotesize\vspace{1mm}
    À la fin de ce document, vous saurez d'où vient chacune des \textbf{129\,504} transactions
...
\begin{frame}{De quoi dispose-t-on exactement, et que peut-on en faire ?}
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \kpi{okgreen}{129\,504}{transactions retenues}\\
...
\begin{frame}{Quatre niveaux de comptage, à ne jamais confondre}
  ...
  \begin{tabular}{@{}l l r >{\raggedright\arraybackslash}p{6.8cm}@{}}
    ...
    \textcolor{okgreen}{\textbf{une TRANSACTION}} & un achat ou une vente & 129\,504 &
      transactions retenues :\newline 107\,976 (déclarations rapides)
      + 14\,050 (rapports, amendements et sorties, flux électronique)
...
\pipeslide{7}{7 · On valorise}
  ...
  {129\,504 transactions exploitables, venues de trois sources}
...
\begin{frame}{Le fil de l'eau : 122\,814 lignes déclarées, 107\,976 valorisables}
  ...
  5\,468 symboles : \textbf{3\,192} séries déjà téléchargées et jamais modifiées $+$ \textbf{819}
  téléchargées pour ce travail $=$ \textbf{4\,011} disponibles, moins \textbf{80} exclues par le
  garde-fou de qualité (moins de 2 points, cours sous 0,10~\$, ou saut quotidien supérieur à
  300~\%) $=$ \textbf{3\,931} séries chargées ; les \textbf{1\,457} derniers symboles sont des échecs
  de téléchargement. Côté déclarations de la Chambre, \textbf{1\,234} symboles finissent sans aucun
  cours (1\,177 échecs jamais rejoués $+$ 57 écartés par le garde-fou) --- ce sont eux qui emportent
  les lignes perdues : MMC 208 lignes, FI 200, WBA 190 en tête.
\end{frame}

\begin{frame}{Des 26\,115 transactions inédites, 14\,050 arrivent au moteur}
  \footnotesize
  ...
  \begin{tabular}{l r r l}
    ...
    aucune série de cours          & $-$1\,309 & 14\,529 & \defl{dont 700 libellés de compte} \\
    déjà dit par une déclaration rapide & $-$479 & 14\,050 & \defl{488 appariements exacts, 479 lignes retirées} \\
    \midrule
    \textbf{trades retenus} & & \textbf{14\,050} & \\
    \bottomrule
  \end{tabular}\\[2mm]
...
\begin{frame}{Le flux final F : 129\,504 transactions, trois sources}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \centering\scriptsize
      \begin{tabular}{l r}
        ...
        rapports annuels, voie électronique & 14\,050 \\
        \defl{11~\% du flux} & \\
        rapports annuels, Schedule B océrisé & 7\,478 \\
        \defl{chez 57 membres} & \\
        \midrule
        \textbf{flux unifié F} & \textbf{129\,504} \\
  ...
  \raggedright
  \repband{F = 129\,504 transactions chez 408 membres = 107\,976 (fil de l'eau) + 14\,050
    (rapports annuels électroniques) + 7\,478 (Schedule B océrisé). Les rapports annuels au sens
    large pèsent donc 21\,528 trades, soit 16,6~\% du flux. Avant l'union, 479 lignes ont été
    retirées (488 appariements exacts membre × ticker × sens × date), soit 3,4~\% des
    14\,529 transactions de rapports candidates.}
\end{frame}
...
\begin{frame}{La photo fait foi : 11\,274 trades ne sont plus rejoués}
  \small
  ...
  \centering
  \kpi{alertred}{11\,274}{trades écartés} \quad
  \kpi{alertred}{696 M\$}{de milieux de fourchette ($\tilde v$)} \quad
  ...
  moteur : ces 11\,274 trades étaient rejoués \emph{en plus} de la photo, donc comptés deux fois.
...
\begin{frame}{De 325 photos d'entrée retenues à 166 portefeuilles injectés}
  ...
  \vspace{0.5mm}
  \centering
  \kpi{okgreen}{7\,780}{lignes (membre, ticker) converties en parts} \quad
  \kpi{okgreen}{83,9 \%}{de la valeur \emph{négociable} des photos (595 M\$)}\\[0.5mm]
  \defl{7\,780 des 8\,860 lignes (membre, ticker) négociables vues en partie I --- les 1\,080 autres
...
\begin{frame}{Partir de zéro coûte 907 M\$ de ventes qu'on ne peut pas passer}
  ...
  \begin{tabular}{lr}
    ...
    C --- déclarations rapides $+$ rapports annuels (sans photo)       & 1\,176 M\$\\
    \textbf{D --- dossier complet}                                     & \textbf{907 M\$}\\
    \bottomrule
  \end{tabular}\\[4mm]
  \raggedright\scriptsize
  Ajouter la photo d'entrée \textbf{réduit} la troncature de 27~\% (937 $\rightarrow$ 688 M\$) ;
  ajouter les rapports annuels l'\textbf{augmente} de 26~\% (937 $\rightarrow$ 1\,176 M\$) : cette
...
\begin{frame}{Le juge est lui aussi filtré : 2\,263 photos annuelles}
  ...
  \kpi{helec}{43\,016}{lignes de positions}\\[2mm]
...
\begin{frame}{Cinq recomptes à la main, chacun avec sa portée exacte}
  ...
  \begin{tabular}{p{4.3cm}p{3.5cm}p{3.3cm}l}
    ...
    \midrule
    les parts initiales $h_0$ & 2 lignes (DMXF, BAC) & échantillon : 2 sur 7\,780 & $10^{-12}$\\
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.33\textwidth}r>{\raggedright\arraybackslash}p{0.42\textwidth}@{}}
    ...
    entre sources : collision exacte avec nos propres déclarations rapides
      & \phantom{0}479 & la déclaration rapide, déposée en médiane 27 j après l'opération
        contre 373 j pour le rapport \defl{(14\,529 $\rightarrow$ 14\,050)}\\
    \bottomrule
  \end{tabular}}\par\vspace{2mm}
  {\scriptsize Ces \textbf{479} lignes distinctes sont retirées pour \textbf{488} appariements
   \defl{(3,36 \% du flux des rapports)} : plusieurs déclarations rapides peuvent s'apparier à
...
\begin{frame}{Un gisement mesuré, chiffré, et laissé de côté}
  ...
  \textbf{129\,504} trades $=$ 107\,976 (déclarations rapides) $+$ 14\,050 (rapports
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.25\textwidth}>{\raggedright\arraybackslash}p{0.33\textwidth}>{\raggedright\arraybackslash}p{0.33\textwidth}@{}}
    ...
    Le portefeuille d'entrée était compté \textbf{deux fois}
      & les trades antérieurs à la photo étaient rejoués \emph{par-dessus} la photo qui les
        déclare déjà
      & \textbf{11\,274} trades écartés, soit \textbf{696 M\$} de montants de transactions,
...
\begin{frame}{Les quatorze choix (1/2) --- construire le flux}
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.25\textwidth}>{\raggedright\arraybackslash}p{0.35\textwidth}>{\raggedright\arraybackslash}p{0.32\textwidth}@{}}
    ...
    Le dépôt le plus ancien gagne
      & $-$2\,103 doublons internes ; $-$479 lignes entre sources \defl{(488 appariements, 3,36 \%)}
...
\begin{frame}{Les quatorze choix (2/2) --- le moteur et la mesure}
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.25\textwidth}>{\raggedright\arraybackslash}p{0.35\textwidth}>{\raggedright\arraybackslash}p{0.32\textwidth}@{}}
    ...
    La photo d'entrée fait foi à sa date
      & $-$11\,274 trades / 696 M\$ / 88 membres
    ...
    Tronquer les ventes à la position détenue
      & surplus journalisé, de 688 M\$ ($+$ photo) à 1\,176 M\$ ($+$ rapports) ;
    ...
    Garde-fou de qualité sur les séries de prix
      & 80 séries corrompues ; 1\,234 tickers sans prix écartent 14\,834 lignes
        \defl{(12,1 \% du House)}
      & 1\,177 de ces tickers sont des échecs \textbf{jamais rejoués}\\\addlinespace[0.6mm]
    \bottomrule
  \end{tabular}}
\end{frame}
...
\begin{frame}{12,1 \% des lignes de transactions déclarées à la Chambre tombent faute de cours}
  ...
  {\footnotesize\begin{tabular}{r l}
    \toprule
    1\,177 & échec de téléchargement enregistré, \textbf{jamais rejoué depuis le 21/07/2026}\\
    ...
    \bottomrule
  \end{tabular}}\\[2mm]
  \defl{le re-jeu de la liste d'échecs est désactivé au run courant · 14\,834 $=$ lignes sans cours
  ...
  \piege{ce n'est pas un manque de la source : les membres ont bien déclaré ces titres.
  C'est un manque de \emph{notre} chaîne, donc réparable.}
\end{frame}

% ── 5. (b) la vérification qui se déclare invalide ────────────────────────────
\begin{frame}{Le test qui devait qualifier ces échecs se déclare lui-même invalide}
  \centering
  {\footnotesize Pour savoir si les 1\,177 tickers en échec sont des sociétés \emph{mortes}
  ou des téléchargements \emph{ratés}, on les rejoue --- avec trois témoins vivants
  glissés dans le lot.}\\[3mm]
  \tuile{grisC}{AAPL}{témoin vivant --- muet}
  \tuile{grisC}{MSFT}{témoin vivant --- muet}
  \tuile{grisC}{SPY}{témoin vivant --- muet}
  \tuile{alertred}{3 / 3}{témoins en échec}\\[4mm]
  {\footnotesize Les trois témoins ne répondent pas non plus : le test ne mesure donc pas
  la mortalité des tickers, il mesure une panne de téléchargement.
  \textbf{On ne peut pas conclure} que les 1\,177 tickers sont morts --- et la liste d'échecs
  contient des sociétés bel et bien cotées (MMC, WBA, ATVI).}\\[3mm]
  \repband{une vérification qui échoue est une information : elle dit que la couverture en prix
  n'est pas qualifiée. Le re-test daté du 21/07/2026, lui, avait bien fonctionné --- il a récupéré
  175 tickers et re-daté 1\,426 échecs. La sonde jouée à l'exécution courante ne reçoit plus
  aucune réponse, témoins compris : c'est l'accès aux cours qui est en panne au moment de la
  mesure, pas les sociétés qui sont mortes. Le re-test est daté et rejouable.}
\end{frame}
  ...
  {\footnotesize\begin{tabular}{>{\raggedright\arraybackslash}p{0.26\textwidth} >{\raggedright\arraybackslash}p{0.36\textwidth} >{\raggedright\arraybackslash}p{0.28\textwidth}}
    ...
    le symbole posé sur un nom de compte
      & lire l'actif et non le compte a rendu \textbf{1\,211} lignes (\textbf{460\,M\$}) ; en sens
        inverse, \textbf{700} des 1\,309 lignes de rapports annuels sans prix portent un libellé de
...
\begin{frame}{Les rapports annuels couvrent 460 membres, la photo d'entrée seulement 243}
  ...
  {\footnotesize\begin{tabular}{l r r}
    ...
    lignes valorisées avec un prix    & 7\,780 lignes de départ construites & 43\,016\\
...
\begin{frame}{La carte des chiffres (3/4) --- les transactions retenues}
  ...
  \quad \textbf{129\,504} trades $=$ 107\,976 déclarations rapides $+$ 14\,050 rapports annuels
        électroniques $+$ 7\,478 \emph{Schedule B} océrisé\\
  \quad les rapports annuels au sens large pèsent 14\,050 $+$ 7\,478 $=$ 21\,528 trades, soit 16,6 \% du flux\\
  ...
  \quad chemin des rapports annuels : 26\,115 $-$ 221 échanges $-$ 14 dates $-$ 290 faux tickers
        $-$ 364 monétaires $-$ 9\,345 fonds $-$ 43 séries corrompues $-$ 1\,309 sans cours
        $-$ 479 doublons $=$ 14\,050\\
...
\begin{frame}{La carte des chiffres (4/4) --- les membres et les portefeuilles}
  ...
  \quad valeur : 11\,480 lignes d'actions (595\,M\$), dont 83,9 \% converti en parts sur 7\,780 lignes\\
  \bottomrule
  \end{tabular}}
\end{frame}
...
\begin{frame}{Ce qu'on a entre les mains}
  \centering
  \tuile{helec}{129\,504}{transactions valorisées}
  ...
  {\footnotesize
  \textbf{Ce qui est solide} --- le flux de transactions : 129\,504 trades décomposables ligne à
