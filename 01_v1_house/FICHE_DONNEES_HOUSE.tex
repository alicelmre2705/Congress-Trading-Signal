...
\phare{230\,215 sur 609\,886}{lignes qui sont vraiment des actions ou des ETF}{vert}
\vis{fig_10_paysage.png}
\pts{
\item La majorité de ce qui est déclaré n'a pas de ticker : immobilier, sociétés non cotées, comptes.
Cela pèse 87,4 Md\$ contre 12,3 Md\$ d'actions et d'ETF.
...
regarde le futur. 85,8\,\% de la valeur en actions de ces photos (562 M\$ déclarés) devient ainsi des parts ; le
...
\phare{9 \% $\rightarrow$ 56 \%}{des positions déclarées retrouvées, sur la photo médiane}{vert}
...
dossier complet & \textbf{56 \%} & 57 \% & 47 \% \\
\bottomrule
\end{tabular}\\[0.6mm]
...
valeur de 44 \% à 47 \%.
\item Une photo n'est confrontable que si une reconstruction existe à sa date : d'où 1\,550 et 1\,807 photos sur les 2\,256 exploitables. Même exercice sur les photos de sortie : 128 confrontées, 60 \% retrouvé et 54 \% juste.
}
...
\item Le patrimoine sans ticker, soit 87\,405 M\$ déclarés, reste hors de portée du moteur.
