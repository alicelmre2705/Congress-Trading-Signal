...
\textbf{133 d'entre eux ont bien déposé} un document que nous ne savons pas encore lire.
}
...
\reponse{Chaque année de mandat donne lieu à un rapport. C'est le \textbf{seul document qui porte les
...
{\footnotesize
On sait qui devait déposer quoi, et ce qu'on a reçu. Reste à ouvrir ces documents --- et chacun s'ouvre
sur \textbf{deux sections qui ne servent pas à la même chose}.\\[0.9mm]
...
$-$ n'est pas une action ni un ETF & --- & $-10\,971$ \\
$-$ aucun prix de marché trouvé$^{\ddagger}$ & $-14\,833$ & $-1\,106$ \\
...
\bottomrule
\end{tabular}\\[0.6mm]
{\footnotesize médianes par photo, sur 1\,550 et 1\,807 photos confrontables}
\end{center}
\vspace{1mm}
\pts{
