...
\item Le graphe partage \textbf{391} traders / \textbf{509} non-traders (391 + 509 = 900) ; le \emph{Schedule B
scanné} en fait trader \textbf{17} de plus $\rightarrow$ le phare \textbf{408}, et \textbf{492} vrais non-traders.
Des 509, \textbf{444} (87 \%) déposent quand même leurs rapports.
...
$-$ aucun prix de marché trouvé$^{\ddagger}$ & $-14\,833$ & $-1\,318$ \\
$-$ déjà connue par ailleurs & --- & $-479$ \\
\midrule
\textbf{retenues} & \textbf{107\,976} & \textbf{14\,084} \\
...
\item $^{\ddagger}$ \textbf{Ces 12 \% ne sont pas une limite de la donnée déclarée} : les membres ont bien
déclaré ces titres. La liste des symboles sans cours a été \textbf{rejouée le 22/07/2026}, réseau vérifié
par trois témoins vivants : \textbf{aucun} des 1\,455 n'a rendu de série. Ce n'est donc pas un raté de
téléchargement --- il faudra une autre source de cours, ou l'accepter comme une limite.
...
regarde le futur. 84,5\,\% de la valeur en actions de ces photos (595 M\$ déclarés) devient ainsi des parts ; le reste
bute sur un prix manquant.
\item \textbf{La photo fait foi à sa date} : les achats antérieurs à son dépôt y figurent déjà, on ne
les rejoue donc pas --- sans quoi la position serait comptée deux fois. Cela écarte 11\,277 transactions
(697 M\$) chez 88 membres.
...
alors six fois plus de positions sans perdre en justesse : la précision monte de 55 \% à 56 \% et la
valeur de 44 \% à 47 \%.
...
\item Environ 43 \% des positions déclarées ne sont pas retrouvées, même avec le dossier complet. Elles
