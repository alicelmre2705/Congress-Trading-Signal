...
\rangee{\begin{etapebox}{1}{bleu}{1 $\cdot$ LA POPULATION --- qui trade}
\reponse{Sur 900 membres de la Chambre, la trajectoire de mandat décide de ce qu'on attend de chacun.}
\phare{408 sur 900}{membres qui tradent des actions cotées}{bleu}
\vis{fig_10_quadrant.png}
\pts{
\item 305 sont vus par leurs déclarations rapides, 86 seulement par leurs rapports annuels, 17 par des
documents scannés.
\item Les autres ne tradent pas d'actions cotées, mais près de 9 sur 10 déposent quand même leurs rapports.
\item Un \textbf{arrivé} doit une photo d'entrée, un \textbf{partant} une photo de sortie : les 149 mandats
complets sont les seuls observables de bout en bout.
}
\src{source : cellules \og qui trade \fg{} et \og validation croisée \fg{} (99~\% d'accord avec le référentiel officiel).}
\end{etapebox}}{\begin{etapebox}{2}{bleu}{2 $\cdot$ ATTENDU VS OBSERVÉ --- a-t-on ce qui est dû ?}
\reponse{Chaque obligation légale se confronte à ce que nos tables contiennent réellement.}
\phare{85 \%}{des années de mandat couvertes par un rapport (médiane par membre)}{bleu}
\vis{fig_10_etape_annuel.png}
\pts{
\item \textbf{Photo d'entrée} : 223 des 312 arrivés encore en poste. \textbf{Photo de sortie} : 253 des
314 partants. \textbf{Rapport annuel} : 212 membres couvrent toutes leurs années, 79 aucune.
\item Une partie des manques est réelle (rien déposé), une partie vient de documents qu'on n'exploite pas
encore --- la distinction est faite membre par membre dans le notebook.
}
\src{source : cellule \og tableau central \fg{}. 5\,702 rapports attendus, un par année en poste au 31 décembre.}
\end{etapebox}}
\vspace{2mm}
