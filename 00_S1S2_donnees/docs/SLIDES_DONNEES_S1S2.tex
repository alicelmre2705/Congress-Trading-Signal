...
\begin{frame}{Les autres dépôts (1/11) — le cycle de vie d'un élu}
  \centering
...
\begin{frame}{Les autres dépôts (2/11) — la famille « patrimoine »}
  \centering
...
\begin{frame}{Les autres dépôts (3/11) — \texttt{O}, le rapport annuel}
  \begin{columns}[c]
...
\begin{frame}{Les autres dépôts (4/11) — \texttt{C}, le rapport de candidat}
  \begin{columns}[c]
    \begin{column}{0.34\textwidth}\centering
...
\begin{frame}{Les autres dépôts (5/11) — \texttt{H}, la déclaration d'entrée}
  \begin{columns}[c]
    \begin{column}{0.34\textwidth}\centering
...
\begin{frame}{Les autres dépôts (6/11) — \texttt{T}, la déclaration de sortie}
  \begin{columns}[c]
    \begin{column}{0.34\textwidth}\centering
...
\begin{frame}{Les autres dépôts (7/11) — \texttt{A}, l'amendement}
  \begin{columns}[c]
    \begin{column}{0.34\textwidth}\centering
...
\begin{frame}{Les autres dépôts (8/11) — surprise : il y a des transactions dedans}
  \centering
  ...
  {\footnotesize la \textbf{Schedule B} d'un rapport annuel \textbf{récapitule les
   ...
   delta 0 jour) — mais est-ce le cas de tout le monde ? → slide 10/11 \quad
...
\begin{frame}{Les autres dépôts (9/11) — les administratifs, et le cas à part}
  \centering
...
\begin{frame}{Les autres dépôts (10/11) — que rate-t-on ? (mesuré)}
  \begin{columns}[c]
...
\begin{frame}{Les autres dépôts (11/11) — qu'est-ce qu'on pourrait faire ?}
  \centering
  \begin{columns}[T]
