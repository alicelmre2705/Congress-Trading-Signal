...
\begin{frame}{Le chemin Sénat (2/3) — le cas électronique}
  \begin{columns}[T]
    ...
    \begin{column}{0.38\textwidth}
      ...
      {\footnotesize un \textbf{gabarit unique} depuis 2014 — mêmes 9 colonnes sur les
       \textbf{1\,777} rapports.}\\[2.5mm]
      {\footnotesize ce qui varie, c'est le \textbf{contenu} :}\\[1.5mm]
      {\footnotesize
      · \textbf{amendements} (10\,\%)\\[1mm]
      · ticker « \co{--} » pour le \textbf{non-coté}\\[1mm]
      · champs remplis au fil des ans}
    \end{column}
  \end{columns}
\end{frame}

% ── II.7 · Sénat papier ── (typologie vérifiée : 5 gabarits ; 255/373 en paysage)
\begin{frame}{Le chemin Sénat (3/3) — le cas papier : 5 types}
  \centering
  \begin{columns}[T]
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=34mm]{slides/senat_papier_couche.png}}\\[0.8mm]
      {\scriptsize\textbf{couché} (le plus courant)}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=34mm]{slides/senat_papier_droit.png}}\\[0.8mm]
      {\scriptsize\textbf{droit}, grille A→L}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=34mm]{slides/senat_papier_annexe.png}}\\[0.8mm]
      {\scriptsize\textbf{annexe} « See Attachment »}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=34mm]{slides/senat_papier_avocat.png}}\\[0.8mm]
      {\scriptsize\textbf{lettre d'avocat}}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=34mm]{slides/senat_papier_courrier.png}}\\[0.8mm]
      {\scriptsize\textbf{courrier} du sénateur}
    \end{column}
  \end{columns}
  \vspace{3mm}
  \badgel{socr}{3\,985 transactions · 2,4\,\%}\quad
  {\scriptsize\color{black!60} 373 rapports · 5 déposants = 95\,\% ·
   255/373 arrivent \textbf{couchés} → ticker à ré-associer}
\end{frame}
