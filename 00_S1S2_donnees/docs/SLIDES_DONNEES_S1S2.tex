...
\begin{frame}{Le chemin Sénat (3/3) — le cas papier : un formulaire, parfois une annexe}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.235\textwidth}\centering
      ...
      {\scriptsize\textbf{…ou droit}}\\{\tiny même form, grille A→L}
    \end{column}
    \begin{column}{0.235\textwidth}\centering
      \href{https://efd-media-public.senate.gov/media/2014/1/000/012/000012036.gif}{%
        \fcolorbox{black!30}{white}{\includegraphics[height=33mm]{slides/senat_papier_manuscrit.png}}}\\[0.6mm]
      {\scriptsize\textbf{…ou manuscrit}}\\{\tiny même form, écrit à la main (Roberts)}
    \end{column}
    \begin{column}{0.235\textwidth}\centering
      ...
      {\scriptsize\textbf{l'annexe « courtier »}}\\{\tiny « See Attachment »}
    \end{column}
  \end{columns}
  \vspace{1.5mm}
