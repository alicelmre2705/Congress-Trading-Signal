...
\begin{frame}{Les autres dépôts (1/10) — la famille « patrimoine »}
  \centering
...
\begin{frame}{Les autres dépôts (7/10) — surprise : il y a des transactions dedans}
  ...
  {\footnotesize la \textbf{Schedule B} d'un rapport annuel \textbf{récapitule les
   ...
   delta 0 jour) — mais est-ce le cas de tout le monde ? → slide 9/10 \quad
...
\begin{frame}{Les autres dépôts (8/10) — les administratifs, et le cas à part}
  \centering
...
\begin{frame}{Les autres dépôts (9/10) — que rate-t-on ? (mesuré)}
  \begin{columns}[c]
...
\begin{frame}{Les autres dépôts (10/10) — qu'est-ce qu'on pourrait faire ?}
  \centering
  \begin{columns}[T]
