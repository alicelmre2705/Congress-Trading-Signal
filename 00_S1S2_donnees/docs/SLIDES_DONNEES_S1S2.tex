...
% ═════════════ II. À QUOI RESSEMBLE LA DONNÉE (4 slides) ═════════════
\section{À quoi ressemble la donnée brute}

% ── S4 · Chambre électronique ── (RAPPORT_FINAL §4.3 « dans la source » ; volume §1 RQ)
\begin{frame}{À quoi ça ressemble (1/4) — Chambre, PTR électronique}
  \begin{columns}[T]
...
% ── S5 · Chambre scannée ── (§4.5 ; census/motifs slide 13)
\begin{frame}{À quoi ça ressemble (2/4) — Chambre, PTR scanné}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}\centering
...
% ── S6 · Sénat électronique ── (§4.4 « dans la source »)
\begin{frame}{À quoi ça ressemble (3/4) — Sénat, déclaration eFD}
  \begin{columns}[T]
...
% ── S7 · Sénat papier ── (§4.6 « dans la source »)
\begin{frame}{À quoi ça ressemble (4/4) — Sénat, papier scanné}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}\centering
