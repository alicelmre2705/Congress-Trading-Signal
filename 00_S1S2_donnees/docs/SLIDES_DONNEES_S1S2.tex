...
\begin{frame}{Le chemin Sénat (1/5) — le site eFD et sa barrière}
  \begin{columns}[T]
    \begin{column}{0.64\textwidth}\centering
...
% ── II.5a · Le formulaire de recherche ── (session réelle 2026-07-12, reconstitution fidèle)
\begin{frame}{Le chemin Sénat (2/5) — chercher : Sénateur × PTR}
  \begin{columns}[T]
    \begin{column}{0.66\textwidth}\centering
      ...
      {\scriptsize\color{black!60} le formulaire, une fois l'accord accepté
       (reconstitution fidèle de la page réelle)}
    \end{column}
    \begin{column}{0.32\textwidth}
      \badge{selec}{on coche : Senator × PTR}\\[2.5mm]
      {\footnotesize
      · les PTR sont \textbf{un type parmi d'autres} (Annual, Blind Trusts,
        Extensions…)\\[1.5mm]
      · notre collecteur envoie la même requête : \co{report\_types=[11]}
        (= PTR), paginée\\[1.5mm]
      · la note du site l'annonce déjà : un rapport s'affiche
        \textbf{tel qu'il a été déposé} — texte ou images}
    \end{column}
  \end{columns}
\end{frame}

% ── II.5bis · La page de résultats eFD ── (capture réelle Senator × PTR : 1 705 entrées)
\begin{frame}{Le chemin Sénat (3/5) — la liste des rapports}
  \begin{columns}[T]
    \begin{column}{0.66\textwidth}\centering
...
% ── II.6 · Sénat électronique (issue 1 du clic) ── (vérifié sur les 1 777 HTML du cache :
%    UNE seule signature d'en-têtes 2014-2026 ; 178 amendements ; ticker -- omniprésent)
\begin{frame}{Le chemin Sénat (4/5) — le clic ouvre… une page HTML}
  \begin{columns}[T]
    \begin{column}{0.60\textwidth}\centering
      \fcolorbox{selec}{white}{\includegraphics[width=\linewidth]{sources/senate_digital.png}}\\[1mm]
      \fcolorbox{selec!50}{white}{\includegraphics[height=16mm,trim=0 700 0 80,clip]{slides/senat_elec_amendement.png}}\\[0.5mm]
      {\scriptsize\color{black!60} variante réelle : « …(Amendment 1) », déposé 7 mois après}
    \end{column}
    \begin{column}{0.38\textwidth}
      \badge{selec}{cas électronique — 13\,026 · 7,7\,\%}\\[2.5mm]
      {\footnotesize
      · un \textbf{gabarit unique} depuis 2014 : mêmes 9 colonnes sur les
        \textbf{1\,777} rapports du corpus (vérifié)\\[1.5mm]
      · ce qui varie, c'est le \textbf{contenu} :\\}
      {\scriptsize
      — \textbf{178 amendements} (10\,\%), déposés parfois des mois après\\[0.8mm]
      — ticker « \co{--} » pour le \textbf{non-coté} (LLC, munis) dans
        l'immense majorité des rapports\\[0.8mm]
      — champs optionnels remplis au fil des ans (Asset Type vide en 2014,
        sous-lignes \emph{Company/Description} ensuite)}
    \end{column}
  \end{columns}
\end{frame}

% ── II.7 · Sénat papier (issue 2 du clic) ── (typologie vérifiée sur les 373 rapports/967 pages :
%    5 gabarits ; 255/373 ont la p.1 en paysage — jamais dire « déjà droites »)
\begin{frame}{Le chemin Sénat (5/5) — …ou des images scannées : 5 réalités}
  \centering
  {\footnotesize \textbf{373 rapports papier} (967 pages) — 5 déposants font 95\,\%
   (Blumenthal 120, Burr 84, Boozman 74…) — et 5 gabarits réels :}\\[2mm]
  \begin{columns}[T]
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=31mm]{slides/senat_papier_couche.png}}\\[0.8mm]
      {\scriptsize\textbf{formulaire couché}\\tapé — le cas dominant\\(Burr 2015)}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=31mm]{slides/senat_papier_droit.png}}\\[0.8mm]
      {\scriptsize\textbf{formulaire droit}\\grille A→L cochée\\(Blumenthal 2020)}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=31mm]{slides/senat_papier_annexe.png}}\\[0.8mm]
      {\scriptsize\textbf{annexe libre}\\« See Attachment »\\(Boozman 2018)}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=31mm]{slides/senat_papier_avocat.png}}\\[0.8mm]
      {\scriptsize\textbf{lettre d'avocat} en p.1\\Elias Law Group, 2021+\\(Blumenthal 2025)}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \fcolorbox{black!30}{white}{\includegraphics[height=31mm]{slides/senat_papier_courrier.png}}\\[0.8mm]
      {\scriptsize\textbf{courrier explicatif}\\du sénateur\\(Feinstein 2021)}
    \end{column}
  \end{columns}
  \vspace{2mm}
  \badgel{socr}{cas papier — 3\,985 txns · 2,4\,\%}\quad
  {\scriptsize\color{black!60} 255/373 arrivent \textbf{couchés} ou en annexe paysage ·
