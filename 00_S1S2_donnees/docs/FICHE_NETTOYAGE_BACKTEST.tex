...
\item \code{flag\_price\_caution} --- code ticker recyclé ou emmêlé par une fusion (505, 0{,}4\,\%) : le
      même symbole a désigné deux sociétés selon l'époque → brancher le cours \emph{en tenant compte de la
      date}, sinon on colle le prix de la mauvaise entreprise.
