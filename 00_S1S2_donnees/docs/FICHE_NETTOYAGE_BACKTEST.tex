...
\begin{itemize}
\item Quiver : \textbf{93{,}5\,\%} (House) / \textbf{92{,}1\,\%} (Sénat) de ses combinaisons retrouvées
      chez nous. \emph{(Combinaison = ce déposant a déclaré au moins un trade sur ce titre dans ce sens ;
      clé sans date, pour tolérer les conventions.)}
\item Après enquête sur le résidu : \textbf{27\,+\,11 « vrais trous »} confirmés, seulement.
\item senate-stock-watcher : \textbf{100\,\%} des 6\,231 transactions retrouvées (hors représentation des
      échanges : 2 lignes chez lui, 1 chez nous).
\item Mirror house-stock-watcher : \textbf{99{,}5\,\%} des lignes 2018--2026 retrouvées (23\,568 transactions).
\end{itemize}

\textbf{2) A-t-on \emph{plus} qu'eux ?}
\begin{itemize}
\item \textbf{+23\,535} trades cotés nets côté House, \textbf{+2\,951} côté Sénat.
