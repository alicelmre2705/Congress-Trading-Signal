...
\item Les combinaisons de Quiver qu'on ne retrouve \emph{pas} (1\,704 côté House, 360 côté Sénat) ne sont
      ...
      \item restent 31 combinaisons cotées côté House (0 côté Sénat) à vérifier une par une.
      \end{itemize}
\item Le décompte \emph{honnête} se mesure au \emph{trade daté} (chaque trade à sa date exacte) : il ne
      manque réellement que \textbf{27 trades côté House et 11 côté Sénat}. \emph{(Autre mesure que les
      31/0 ci-dessus, sur une autre clé : celle-ci compte chaque trade à sa date, l'autre comptait les
      paires titre-sens sans date --- un membre peut avoir la bonne paire et un trade daté en moins, d'où
