...
\item \textbf{Filet de non-régression} : 368 fichiers de référence figés SHA-256 (230 House + 138 Sénat),
      ...
      le notebook s'exécute hors-ligne et de façon déterministe (deux runs = même table).
\end{itemize}
...
les paires), \textbf{réparée} (19 corrections documentées, chacune avec sa preuve, dans l'audit), \textbf{honnête} (tout
