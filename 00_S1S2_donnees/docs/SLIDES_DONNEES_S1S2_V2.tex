...
\begin{frame}{2a · Extraction Chambre · texte --- un PDF n'est pas un tableau}
  \begin{columns}[T]
    \begin{column}{0.54\textwidth}\centering
      \clickzoom{fig_ptr_multiligne}{\includegraphics[width=\linewidth,height=0.36\textheight,keepaspectratio]{slides/fig_ptr_multiligne.png}}\\[0.5mm]
...
\begin{frame}{2b · Extraction Chambre · image --- l'OCR lit le tapé, le manuscrit est écarté}
  \centering
  {\footnotesize l'\textbf{OCR par IA} (Claude Vision) lit le \textbf{tapé} --- même tourné à
   90° --- ; le \textbf{manuscrit} cursif est le seul point dur
   \;{\scriptsize\color{black!45}(images cliquables)} :}\\[2mm]
  \begin{columns}[T]
    \begin{column}{0.27\textwidth}\centering
      \fcolorbox{helec}{white}{\clickzoom{scan_full_droit}{\includegraphics[height=30mm]{slides/scan_full_droit.png}}}\\[1mm]
      {\footnotesize\textbf{Tapé} → \textbf{lu}}
    \end{column}
    \begin{column}{0.27\textwidth}\centering
      \fcolorbox{hocr}{white}{\clickzoom{scan_full_manuscrit}{\includegraphics[height=30mm]{slides/scan_full_manuscrit.png}}}\\[1mm]
      {\footnotesize\textbf{Manuscrit} → \textbf{écarté}}
    \end{column}
    \begin{column}{0.43\textwidth}\footnotesize
      \badgel{hocr}{93\,325 → 93\,261 lignes uniques}\\[2mm]
      \colorbox{black!6}{\parbox{0.96\linewidth}{\scriptsize
        \textbf{la mesure} --- \textbf{Quiver} (notre mètre externe, Partie II) ne corrobore
        que \textbf{\mbox{12,9\,\%}} du manuscrit, contre \textbf{\mbox{88\,\%}} du tapé →
        on ne peut pas le \textbf{vérifier}}}\\[2mm]
      \badge{alertred}{582 manuscrits écartés --- 7,1\,\%}
    \end{column}
  \end{columns}
  \vspace{2mm}
  \choixbox{\textbf{on ne met en table que ce qu'on sait lire} --- sur les \textbf{775 scans
   manuscrits}, \textbf{582 écartés} par une règle écrite et rejouable ; les \textbf{193}
   restants, corroborés par Quiver, sont \textbf{lus} (exceptions explicites).}
\end{frame}
...
\begin{frame}{2c · Extraction Sénat · texte --- une table déjà propre, stable sur 13 ans}
  \begin{columns}[T]
    \begin{column}{0.54\textwidth}\centering
      \fcolorbox{selec}{white}{\clickzoom{senate_digital_2}{\includegraphics[width=0.96\linewidth,height=0.30\textheight,keepaspectratio]{sources/senate_digital.png}}}\\[0.5mm]
