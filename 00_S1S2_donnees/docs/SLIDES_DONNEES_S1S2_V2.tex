  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{tabular}{@{}p{0.55cm}>{\raggedright\arraybackslash}p{2.3cm}>{\raggedright\arraybackslash}p{3.4cm}@{}}
        ...
        \etape{2}{Extraction}{les dates · 4 voies · le corpus}
...
\begin{frame}{2c · Extraction Chambre · image --- l'OCR lit le tapé, le manuscrit est écarté}
  \centering
...
\begin{frame}{2d · Extraction Sénat · texte --- une table déjà propre, stable sur 13 ans}
  \begin{columns}[T]
  ...
  \end{columns}
  \vspace{1mm}
  \diff{là où la \chambre{} impose de \textbf{reconstruire} un PDF (2b), le \senat{}
