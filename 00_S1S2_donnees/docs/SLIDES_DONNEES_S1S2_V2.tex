  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \colorbox{black!6}{\parbox{\dimexpr\linewidth-8pt}{\tiny\vspace{0.4mm}
        ...
        (I.1, I.3), une seule slide \textbf{là où c'est identique}\vspace{0.4mm}}}\\[2mm]
      \colorbox{black!6}{\parbox{\dimexpr\linewidth-8pt}{\tiny\vspace{0.4mm}
...
\begin{frame}{I.0 · Le pipeline complet --- tout le trajet de la donnée}
  ...
  {\scriptsize\color{black!55} ce schéma \textbf{revient avant chaque étape}, l'étape en
   cours allumée \;·\; \textbf{OCR} = lecture automatique d'une image (I.2c)}\\[0.5mm]
...
\begin{frame}{I.2a · Tri par type --- sur douze types de dépôts, un seul porte le signal : le \texttt{P}}
  ...
  \idem{le Sénat a une typologie \textbf{analogue} (annuels, extensions,
   \emph{blind trusts}…) --- on ne demande au portail que les \textbf{PTR}.}\\[1mm]
...
\begin{frame}{I.2b · Tri par format --- texte ou image : quatre sous-corpus}
  ...
  \idem{les deux chambres ont leur monde \textbf{texte} et leur monde \textbf{image} ---
   au final, \textbf{57,5\,\%} du corpus viendra d'images.}\\[1mm]
...
% ── A2 · La recherche eFD, en détail ──
\begin{frame}{A2 --- Le portail du Sénat : la recherche, puis la liste}
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}\centering
      \fcolorbox{black!25}{white}{\includegraphics[width=0.92\linewidth]{slides/site_senate_form.png}}\\[0.5mm]
      {\scriptsize\color{black!60} le formulaire : on coche \textbf{Senator} ×
       \textbf{PTR} --- c'est ce qui remplace l'index de la Chambre}
    \end{column}
    \begin{column}{0.48\textwidth}\centering
      \fcolorbox{black!25}{white}{\includegraphics[width=0.92\linewidth]{slides/site_senate_results.png}}\\[0.5mm]
      {\scriptsize\color{black!60} la liste réelle : un lien par dépôt --- chacun
       s'ouvre en page web ou en scan}
    \end{column}
  \end{columns}
  \vspace{2.5mm}
  \centering
