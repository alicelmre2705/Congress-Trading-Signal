...
stratégie.
\textbf{La table.} Les chiffres de cette fiche sont mesurés sur la table du 04/07/2026 (archivée).
La table \emph{courante} du pipeline (corrections de tickers --- note de version
\texttt{NOTE\_DIFF\_TABLE\_CLEAN}) déplace les résultats de quelques centièmes de point sans changer
aucune conclusion : $+3{,}42$ / $+1{,}21$ / $+2{,}51$ contre $+3{,}40$ / $+1{,}24$ / $+2{,}51$ ---
la passerelle chiffrée est le notebook \texttt{17\_M3\_Table\_Courante}.\par
\vspace{0.5mm}
