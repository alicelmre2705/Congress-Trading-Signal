...
% Format repris de 00_recuperation_donnees/docs/SLIDES_DONNEES_S1S2_V2.tex (mêmes thème/macros).
...
% + 02_recherche_backtest/ETAT_DE_L_ART_STRATEGIES.md). Règles du chef : une idée/slide (titre = message),
