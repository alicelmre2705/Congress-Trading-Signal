...
- **Données** : `data/clean/transactions_backtest_2020_2026.csv` — 72 368 lignes, 100 % avec ticker,
  ...
  Variante longue si on veut 2014-2026 : `02_recherche_backtest/table_congres_2014_2026.csv`.
- **Prix** : `02_recherche_backtest/cache/prices/*.csv` — 2 172 tickers en clôture ajustée quotidienne
