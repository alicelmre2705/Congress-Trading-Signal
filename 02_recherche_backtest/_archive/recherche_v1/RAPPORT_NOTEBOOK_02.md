...
2. **Localisation autonome** via `_find_paths()` : le notebook cherche lui-même le dossier `02_recherche_backtest/` et la racine du dépôt, pour savoir **où écrire** (`OUT`) et où mettre ses caches (`CACHE = build_cache/`).
