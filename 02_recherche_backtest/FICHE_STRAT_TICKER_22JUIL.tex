...
\item \textbf{Le placebo ne le valide pas} : en réaffectant les comités \textbf{au hasard} (20 tirages), la médiane des placebos tombe à $+0{,}41\,\%$/an --- mais leur \textbf{maximum atteint $+8{,}31$}, \emph{au-dessus} du $+7{,}67$ réel. Le réel ne dépasse que \textbf{90~\%} des tirages : au seuil usuel, cet écart ne se distingue pas du hasard.
\end{pts}
