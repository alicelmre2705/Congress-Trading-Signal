...
\item \textbf{Livre initial} à la création $t_0=$ 06/02/2023 : le net $\gamma$ des 3 ans précédents, converti en \textbf{parts} au prix de $t_0$.
...
\item \textbf{V4 $=$ V3 $+$ les resets documentés} : livre construit à $t_0$ (600 lignes, régime Subversive), puis au \textbf{reset} $t_1=$ 02/08/2024 on \textbf{élague aux 170 plus grosses} lignes (\og{}\emph{eliminated 582 very small positions}\fg{}) et la dérive reprend.
\item \textbf{V5 $=$ une mécanique par régime} --- puisque le fonds en a changé (B1bis) : \textbf{V1} (score recomposé chaque mois) \textbf{jusqu'au 02/08/2024}, puis le portefeuille est converti en \textbf{parts} et bascule en \textbf{V3} (livre qui dérive). $\Rightarrow$ $q_i(t_1)=w^{\text{V1}}_i\,S/P_i$, avec $S$ la taille du livre en \$ ; puis dérive.
\item \textbf{V6 $=$ V5 $+$ élagage en continu} --- le fonds tient 104--139 lignes, V5 en accumule 719. Chaque mois, après les divulgations, on ne garde que les $n=150$ plus grosses lignes \textbf{en valeur} ($n=$ milieu de la fourchette publiée $[100,200]$, pas un chiffre calé sur la cible) : $q^{(6)}(c)=\mathrm{top}_n\bigl(\mathcal{E}(q^{(6)},\,c^-\!\to c)\bigr)$.
\end{pts}
\obs{\emph{Piège rencontré} : convertir les poids ($\sum w=1$) en parts \textbf{sans les mettre à l'échelle en dollars} fait qu'un seul achat de quelques milliers de \$ écrase tout le livre. Il faut calibrer $S$ sur la taille du régime.}
...
\obs{\textbf{V4} (resets documentés) bat V3 : recouvrement du top-10 \textbf{51 $\to$ 57 \%}, exposition 46 $\to$ 48 \%, cardinal 1\,239 $\to$ 723. Reconstruire entièrement au reset (au lieu d'élaguer) \emph{dégrade} (recouv.\ 40 \%) --- l'élagage est bien la bonne lecture de \og{}\emph{eliminated 582 very small positions}\fg{}.}
\obs{\textbf{V5 est la meilleure version --- et la seule qui rende le GOP non dégénéré.} NANC : $\rho$ \textbf{0,75} (record) ; GOP : $\rho$ passe de 0,11--0,16 à \textbf{0,26}, top-10 de 0/10 à 1/10, recouvrement 14 $\to$ 20 \%. \emph{Mais} V1 garde le meilleur recouvrement du top-10 NANC (65 \% contre 57 \%) : \textbf{aucune version ne domine sur tous les critères}.}
\obs{\textbf{V6 (élagage continu) : le cardinal est réglé, la fidélité \emph{recule}.} On passe de 719 à \textbf{150 lignes} (réel 104/139) et la rotation baisse (26 $\to$ 21 \%), mais le $\rho$ \emph{de rang} s'effondre ($+0{,}32\to-0{,}02$ pour NANC, $+0{,}28\to-0{,}22$ pour GOP). \textbf{Pourquoi c'est instructif} : tronquer notre classement supprime des titres que le fonds détient vraiment --- nos 150 plus grosses lignes ne sont \emph{pas} ses 104. C'est une nouvelle preuve que \textbf{c'est notre ordre de grandeur relatif qui est faux}, pas la longueur de la liste.}
...
V3/V4 (livre) & 13 \% & 11 \% & 16 \% & \textbf{13 \%} \\
\textbf{V5} (bascule) & 48 \% & 37 \% & 26 \% & --- \\
\textbf{V6} ($+$ élagage) & 48 \% & 34 \% & 21 \% & --- \\
\addlinespace[1pt]
...
\obs{\textbf{C'est la découverte du dossier.} Le fonds tournait à \textbf{44--62 \%} en 2023-24 (régime \emph{Subversive}) $\approx$ notre \textbf{V1} (59--67 \%) ; il est tombé à \textbf{10 \%} en 2025 (régime \emph{Tidal}) $\approx$ notre \textbf{V3/V4} (11--16 \%). \emph{Aucune version unique ne peut coller aux deux} : le fonds a \textbf{changé de mécanique} en août 2024, et nos V1 et V3 décrivent chacune \textbf{une moitié} de son histoire.}
...
NANC \textbf{V5} & 2023-26 & $\mathbf{+2{,}46}$ & $+1{,}46$ & 1,06 & 213 \\
GOP \textbf{V5} & 2023-26 & $-0{,}27$ & $+1{,}13$ & 0,93 & 196 \\
\bottomrule
\end{tabular}
\end{center}
