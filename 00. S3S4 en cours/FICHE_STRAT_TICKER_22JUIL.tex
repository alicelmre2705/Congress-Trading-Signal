...
\emph{ventes récentes}. On peut le prendre au pied de la lettre : par (élu, titre), file \textbf{FIFO} des achats
sur la fenêtre, chaque vente consomme les plus anciens ; l'excédent (vente d'un \emph{vieux} lot pré-fenêtre) est
\textbf{ignoré} --- le prospectus dit de ne pas l'ajuster --- d'où $\mathrm{net}_i\ge 0$ ; score $s_i=\mathrm{net}_i\times m_i$,
...
NANC $\cdot$ V2 (net FIFO) & $+2{,}49\,\%$ & $+0{,}38\,\%$ & \textbf{621} & 5/10 \\
GOP $\cdot$ V1 (achats)    & $+1{,}24\,\%$ & $+1{,}12\,\%$ & \textbf{612} & --- \\
GOP $\cdot$ V2 (net FIFO)  & $+1{,}84\,\%$ & $+1{,}78\,\%$ & \textbf{663} & --- \\
\bottomrule
\end{tabular}
\end{center}
\obs{Le netting \textbf{ne change pas les têtes} (ventes de vieux lots ignorées, comme le veut le texte) :
recouvrement \textbf{5/10} identique, $\rho$ 0,67 vs 0,73. V2 un peu \emph{moins} bien pour NANC, un peu
\emph{mieux} pour GOP --- \textbf{autre manière d'interpréter} la même règle. Sans le cap, le score exploserait
(NVDA 32 \%, $N_{\mathrm{eff}}$ 7 vs 33 réel). \emph{Recouv./}$\rho$\emph{ sur NANC seul : holdings réels GOP non fournis.}}
