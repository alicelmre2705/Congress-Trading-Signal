...
\end{pts}
\lire{le détail (leurs documents, nos trois lectures de leur règle, la composition ligne à ligne, le diagnostic) est dans la fiche dédiée \textbf{FICHE\_NANC\_GOP}.}
\end{multicols}
