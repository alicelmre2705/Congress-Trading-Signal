...
\midrule
NANC (Dém.) & $+0{,}23\,\%$ & 0,18 & $-0{,}81\,\%$ & 1,05 & 527 \\
GOP (Rép.) & $+0{,}67\,\%$ & 0,22 & $-0{,}29\,\%$ & 1,02 & 549 \\
\bottomrule
\end{tabular}
\end{center}
\fig{nanc_gop.png}{}
...
\begin{pts}
\item \textbf{Ce n'est pas un sous-comptage} : ETF écartés $=2{,}5\,\%$ du \$ (VTI/SPY, du marché) ; 296 titres non cotés $=6{,}5\,\%$ (fusions --- même tous $\times2$ ne ferait que $+6{,}5\,\%$) ; \textbf{équipondérer donne \emph{moins}} (NAV 454 $<$ 565). Toute construction défendable $\Rightarrow \beta\approx1$, $\sim$22 \% $=$ SPY.
\item \textbf{Leurs propres chiffres donnent $\sim$24 \%, pas 36 \%} : leur $\beta$ 1,14 $\Rightarrow$ CAPM $24\,\%$/an ; leur Sharpe 1,082 $\Rightarrow$ $24\,\%$/an ; leur vol affichée $4{,}63\,\%$ est \textbf{impossible} pour $\beta$ 1,14 (qui impose $\ge17\,\%$ --- c'est une vol \emph{mensuelle}). Leur $\beta$ et leur Sharpe pointent \textbf{notre} chiffre ; seul leur \textbf{titre 36 \%} est incohérent avec leur propre risque.
\end{pts}
