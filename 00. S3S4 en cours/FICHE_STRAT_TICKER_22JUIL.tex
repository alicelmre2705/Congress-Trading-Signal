...
\begin{tabular}{@{}l r r r r r@{}}
\toprule
V2 \emph{2014-26} & exc./an & $t$ & $\alpha$/an & $\beta$ & NAV \\
\midrule
NANC (Dém.) & $+2{,}49\,\%$ & 1,12 & $+0{,}38\,\%$ & 1,08 & 621 \\
GOP (Rép.)  & $+1{,}84\,\%$ & 1,77 & $+1{,}78\,\%$ & 1,00 & 663 \\
\bottomrule
\end{tabular}
\end{center}
\obs{Le netting \textbf{ne change pas les têtes} (les ventes de vieux lots sont ignorées, comme le veut le texte) :
recouvrement \textbf{5/10} identique, $\rho$ 0,67 (vs 0,73), exposition commune 48 \% (vs 51 \%). C'est \textbf{une
autre manière d'interpréter} la même règle, ni meilleure ni pire. \emph{Sans} le cap, le score exploserait
(NVDA 32 \%, $N_{\mathrm{eff}}$ 7 vs 33 réel) : le vrai fonds pondère bien plus doucement que le nôtre.}
