...
% ═══════════ ANNEXE : extraits verbatim ═══════════
\vspace{2mm}\hrule\vspace{1.5mm}
{\color{bleu}\bfseries\large Annexe --- extraits sources (verbatim)}\par\vspace{1mm}
{\footnotesize\color{grisf} Extraits reproduits tels quels ; source sous chaque bloc. L'interprétation et le mapping vers notre code sont dans les sections \textbf{1} (Quiver) et \textbf{2} (NANC/GOP) ci-dessus.}\par\vspace{2mm}

\textbf{NANC} --- \emph{prospectus \og{}Unusual Whales Subversive Democratic Trading ETF\fg{}, \og{}Principal Investment Strategies\fg{}, p.\,2} :
...
\textbf{GOP} --- \emph{prospectus \og{}Unusual Whales Subversive Republican Trading ETF\fg{}, \og{}Principal Investment Strategies\fg{}, p.\,2} :
{\footnotesize\itshape
...
\textbf{Quiver --- Congress Buys} \emph{(quiverquant.com)} :
...
\textbf{Quiver --- Congress Long-Short} \emph{(quiverquant.com)} :
