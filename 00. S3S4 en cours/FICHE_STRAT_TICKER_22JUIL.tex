...
\textbf{1. NANC / GOP} (ETF Subversive). \textbf{Ce qu'ils disent faire} :
\begin{pts}
\item Univers = titres tradés par les élus \textbf{Démocrates} (NANC) / \textbf{Républicains} (GOP) ; sur \textbf{3 ans glissants}, achats \textbf{nettés} des ventes, \textbf{pondérés au montant} (\$), 100--200 titres, à la \textbf{divulgation} $\delta$.
\end{pts}
\[ \begin{gathered} w^{\text{NANC}}_{i,t} \;=\; \frac{\bigl[\,S_{i,t}\,\bigr]^{+}}{\sum_j \bigl[\,S_{j,t}\,\bigr]^{+}},\qquad \textstyle\sum_i w_i=1 \\[1pt] S_{i,t}=\!\!\sum_{k\,\in\,\text{parti},\ t-3\text{ans}<\delta_k\le t}\!\! A_k\,(\mathbf{1}_{achat}-\mathbf{1}_{vente}) \end{gathered} \]
\begin{center}\scriptsize
\begin{tabular}{@{}l r r@{}}
\toprule
total/an \emph{2023-26} & annoncé & réplique \\
\midrule
NANC (Démocrates) & $\sim$22 \% & \textbf{19,1 \%} \\
GOP (Républicains) & $\sim$17 \% & \textbf{16,3 \%} \\
...
\midrule
NANC (Dém.) & $+0{,}23\,\%$ & 0,18 & $-0{,}82\,\%$ & 1,05 & 527 \\
GOP (Rép.) & $+0{,}70\,\%$ & 0,23 & $-0{,}33\,\%$ & 1,03 & 550 \\
\bottomrule
\end{tabular}
\end{center}
\fig{nanc_gop.png}{}
\textbf{Ce qu'on observe} :
\begin{pts}
\item Notre réplique reproduit leurs holdings : \textbf{NVDA} 25,5 \%, PANW 9,5, AVGO 9,2, META, GOOG, PLTR\dots{} = méga-cap tech.
\item $\beta \approx 1$, $\alpha \approx 0$ : leurs $\sim$22/17 \% = le \textbf{rendement du marché} sur 2023-26 (SPY $\sim$21 \%), pas un excès. Sur 2014-26 complet, réplique $\approx$ \textbf{14 \%/an} $=$ SPY.
\end{pts}
