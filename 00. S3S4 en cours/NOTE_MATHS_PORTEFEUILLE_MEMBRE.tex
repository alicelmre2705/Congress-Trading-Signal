...
\section{Ajustement par le marché (\texorpdfstring{$\beta$}{beta})}\label{sec:beta}
L'IR soustrait \emph{tout} le marché $\Rightarrow$ il suppose $\beta=1$. Un portefeuille agressif
