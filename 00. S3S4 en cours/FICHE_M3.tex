...
\end{pts}
\begin{pts}
\item \emph{conséquence} : le plafond de 10~\% \textbf{ne survit pas} à l'agrégation --- la plus grosse ligne
      pèse alors 46,6~\% (démocrates) et 42,2~\% (républicains) ;
\item \emph{conséquence} : avant juin 2018 XLRE et XLC ne cotent pas, leur poids est réparti au prorata ---
      la fenêtre \textbf{2019--2026} fait foi.
\end{pts}
