...
\end{tabular}\par}
\vspace{0.2mm}
{\scriptsize\color{grisf} lignes ETF mesurées avec la \textbf{carte datée} ; les deux plus hauts $t$ de
\emph{ce tableau} \textbf{n'atteignent pas le seuil} de 2,18 qu'exigent treize années --- annexe D.}\par
...
4,2~\%, deux années sur trois l'écart au SPY tient dans une bande de $\pm 4{,}2$~\%. \textbf{Fenêtre 2020--2026,
