...
\includegraphics[width=\linewidth]{figures/fig_nb05b_hist_2t.png}
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\includegraphics[width=0.9\linewidth]{figures/fig_nb05b_regression_strat.png}
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\includegraphics[width=\linewidth]{figures/fig_nb05b_exces_fige_derive.png}
\captionof{figure}{Excès annuel top-4 ($1/K$) : combinaison figée vs corrigée (écart le plus net en 2021).}
\end{minipage}
\end{center}
