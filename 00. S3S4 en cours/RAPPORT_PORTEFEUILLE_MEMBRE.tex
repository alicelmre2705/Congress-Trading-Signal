...
\textbf{Illustration sur un membre (J.~Fetterman).} $V(t)$ saute à chaque trade
(apports + performance mélangés) ; la NAV isole la performance pure ; la régression
donne son $\beta$ et son talent : IR 2,48, $\beta$ 1,17, $\alpha_{\text{ann}}$ $+40{,}2\,\%$,
appraisal 2,24 ($t_{\text{appr}}$ 2,38) ; CAGR $+79{,}7\,\%$, vol 21\,\%, maxDD $-16\,\%$
--- sur \textbf{284 jours seulement}.
...
\captionof{figure}{La régression du membre démo : 1 point $=$ 1 jour ; pente $=\beta=1{,}17$,
