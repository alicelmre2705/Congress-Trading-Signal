...
\begin{pts}
\item \textbf{Le fonds a changé de méthode.} Son taux de rotation passe de \textbf{62 \% en 2024}\sAquatre{39} \textbf{à 10 \% en 2025}\sAcinq{27} : il gérait activement, il ne touche presque plus à rien.
\item \textbf{Un événement daté} : le \textbf{02/08/2024} un nouveau gérant (Tidal) reprend\sChg{3} et \og{}\emph{eliminated 582 very small positions}\fg{}\sAquatre{2} --- de $\sim$600 lignes à $\sim$170.
...
\midrule
rotation FY2023\sAtrois{74} & 44 \% & 46 \% \\
