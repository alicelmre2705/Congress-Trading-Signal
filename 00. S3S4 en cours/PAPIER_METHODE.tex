...
\newcommand{\figfull}[2]{\begin{center}\includegraphics[width=0.84\linewidth]{#1}\end{center}\vspace{-2.5mm}\begin{center}\begin{minipage}{0.86\linewidth}{\scriptsize\color{grisf} #2}\end{minipage}\end{center}\vspace{1mm}}
...
\figfull{meth_nav.png}{les NAV, \textbf{toutes rebasées à 100 au 03/02/2014} --- la seule façon de les comparer d'un seul regard (échelle log). Sur cette fenêtre commune : M1 \textbf{530}, M2 \textbf{584}, \textbf{M3 672}, M4 \textbf{698}, \textbf{SPY 528}.}
