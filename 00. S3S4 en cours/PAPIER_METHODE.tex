...
2\,755 \textbf{actions cotées}, 2014--2026). Chaque déclaration donne un titre, un sens, une date, et une \emph{fourchette} de
...
$\ \mathrm{TO}_t=\tfrac12\sum_i\bigl|w^{\text{réalisé}}_i-w^{\text{dérivé}}_i\bigr|$, la fraction du
portefeuille qui change de mains. \textbf{Elle ne se règle pas, elle découle de la fenêtre} : à chaque coupe
celle-ci avance d'un mois, or 42 jours n'en contiennent que \textbf{deux} --- la moitié du signal est renouvelée
et le classement se refait --- quand 3 ans en contiennent \textbf{trente-six}, dont un seul change. D'où
l'écart mesuré : \textbf{59~\%} de rotation par mois pour M1, \textbf{5~\%} pour M2--M4.
