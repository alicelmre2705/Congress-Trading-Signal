...
$\mathcal U$ --- les 150 plus gros, défini au bloc suivant --- et le plafond $\Pi_c$ sont \textbf{déjà ceux de
M3}, pour que la comparaison M2 \emph{vs} M3 isole le seul facteur ajouté et non la sélection. Ce qui n'est pas
...
un plafond de 25). Sur M3, \textbf{sur 3~\% des coupes} seulement --- les rares mois de forte recomposition. La
...
frais, frein). Facteurs Fama-French-Carhart, \path{cache/ff_factors.csv}. L'étude de fidélité au fonds NANC ---
dont M4 reprend le filtre --- fait l'objet d'un document distinct, \path{FICHE_NANC_GOP.pdf}.\par}
\end{multicols}
