...
{\small Quatre méthodes, trois épreuves --- et ce qui reste quand on a tout contrôlé}
\end{center}
...
% ═══════════ ÉPREUVE 1 ═══════════
\meth{$\star$}{Épreuve 1 --- l'excès n'est-il qu'une exposition déguisée ?}{on régresse sur les quatre facteurs
du \S0 ; les chargements sont dans le tableau de tête.}
...
% ═══════════ ÉPREUVE 2 ═══════════
\meth{$\circlearrowright$}{Épreuve 2 --- le résultat tient-il année après année ?}{un $\alpha$ moyen sur douze ans
...
% ═══════════ ÉPREUVE 3 ═══════════
\meth{\textdollar}{Épreuve 3 --- que coûte l'exécution, et faut-il ralentir ?}{tous les chiffres précédents sont
...
\textbf{Payer l'impact de marché} --- le passage d'ordre est facturé (épreuve 3), l'effet d'un ordre \emph{sur le
...
\item \textbf{Où loge l'$\alpha$ ?} \emph{Dans le temps}, c'est fait (épreuve 2) : diffus, positif $\approx$70~\%
...
\textbf{Mesure indépendante} : Baulkaran \& Jain, \emph{Economics Letters} 250 (2025), ne trouvent aucun
$\alpha$ significatif sur les \emph{ETF réels} --- \textbf{cinq} facteurs (les quatre mêmes plus CMA), rendement
brut, 2023--24. Objet différent du nôtre : le fonds commercialisé, non une stratégie reconstruite. L'étude de fidélité
