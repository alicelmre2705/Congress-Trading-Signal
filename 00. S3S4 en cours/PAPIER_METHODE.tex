...
\end{tabular}
\end{center}
\fig{meth_rolling.png}{$\beta$ (en haut) et $\alpha$ (en bas) réestimés sur chaque fenêtre d'un an --- fenêtres chevauchantes : ces courbes décrivent, elles ne testent pas. \textbf{Le
