  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.43\textwidth}
      ...
      \colorbox{warnorange!12}{\parbox{0.96\linewidth}{\footnotesize\vspace{0.5mm}
        ...
        et McCaul (\textbf{27\,123}), \textbf{tous deux à la Chambre}, pèsent à eux deux \textbf{$\sim$40\,\%} du corpus,
...
\begin{frame}{Le flux de bout en bout, en une image}
  ...
  \begin{tikzpicture}[node distance=3mm]
    ...
    \node[step=selec, text width=2.9cm] (sgif) at (5.5,-1.35) {\textbf{image papier}\\\co{.gif}, souvent couchée};
...
\begin{frame}{Lire le papier Sénat : du formulaire au structuré}
  \begin{columns}[c]
    \begin{column}{0.34\textwidth}\centering
      ...
      {\scriptsize\color{black!60} l'image \co{.gif} --- ici droite, mais 255/373 sont couchées}
    \end{column}
    ...
    \begin{column}{0.52\textwidth}
      ...
      {\scriptsize · \textbf{même moteur Vision} que la Chambre, mais \textbf{sans redressement} :
       Vision lit l'angle tel quel (le prompt annonce « 90° ou 180° »)\\
       · le \textbf{manuscrit est gardé} ici — non pas qu'il soit meilleur : Quiver est
       \textbf{aveugle au papier du Sénat}, donc \textbf{aucun mètre externe} pour le gater
       (garde-fous internes : fenêtre de dates plausibles)\\
...
% ══════════════════════════════════════════════════════════════════
% PARTIE II — LE BACKTEST  (copiée depuis 01_autres_filing_types/slides, branche v1-house)
