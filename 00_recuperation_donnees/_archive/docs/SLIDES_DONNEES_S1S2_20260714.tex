...
\graphicspath{{../../docs/}{figs/}}   % repare 2026-08-11 : deplace de 01/slides vers 00/_archive/docs   % figures historiques + figures V1
...
\begin{frame}{Le chemin Sénat (1/5) — de l'accès au document}
  ...
  \begin{columns}[c]
    \begin{column}{0.5\textwidth}\centering
      \fcolorbox{black!25}{white}{\includegraphics[width=0.90\linewidth]{slides/site_senate_results.png}}\\[0.5mm]
...
% Chiffres : 01_autres_filing_types/cache/tables/*.csv + cache/MANIFEST.json (run post-B4, tout le papier OCRisé).
