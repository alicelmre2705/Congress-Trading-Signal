...
% + lignée v1-house (01_autres_filing_types/cache/) pour la Cohérence. Figures : docs/{slides,quality,sources}/.
...
\begin{frame}{1a · Chambre · acquisition --- récupérer les dépôts depuis l'index annuel}
  \begin{columns}[T]
    \begin{column}{0.40\textwidth}\centering
      \fcolorbox{black!25}{white}{\clickzoom{site_house_clerk}{\includegraphics[width=0.95\linewidth,height=22mm,keepaspectratio]{figs_deck/site_house_clerk.png}}}\\[0.8mm]
    ...
    \begin{column}{0.57\textwidth}\centering
      \clickzoom{fichier_index_xml}{\includegraphics[width=0.94\linewidth,height=37mm,keepaspectratio]{figs_deck/fichier_index_xml.png}}\\[0.5mm]
...
\begin{frame}{1a · Chambre · tri --- choisir les PTR : on lit la lettre \textbf{P} dans l'index}
  \centering
  \vspace{0.5mm}
  \includegraphics[width=0.70\textwidth,height=0.52\textheight,keepaspectratio]{figs_deck/fig_filingtypes.png}\\[3mm]
...
\begin{frame}{1a · Chambre · tri --- distinguer les PTR lisibles des scannés}
  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}\centering
      \fcolorbox{helec}{white}{\clickzoom{house_digital}{\includegraphics[width=0.58\linewidth,height=0.40\textheight,keepaspectratio]{figs_deck/house_digital.png}}}\\[1.2mm]
      \badge{helec}{PDF lisible --- 71\,\%}\\[0.6mm]
      {\scriptsize couche texte, lu directement \;·\; DocID en \co{2\ldots}}
    \end{column}
    \begin{column}{0.46\textwidth}\centering
      \fcolorbox{hocr}{white}{\clickzoom{house_ocr}{\includegraphics[width=0.58\linewidth,height=0.40\textheight,keepaspectratio]{figs_deck/house_ocr.png}}}\\[1.2mm]
...
\begin{frame}{1b · Sénat --- choisir les PTR de tous les membres}
  \begin{columns}[T]
    \begin{column}{0.40\textwidth}\centering
      \fcolorbox{black!25}{white}{\clickzoom{site_senate_form}{\includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{figs_deck/site_senate_form.png}}}\\[0.6mm]
    ...
    \begin{column}{0.57\textwidth}\centering
      ...
      \includegraphics[width=\linewidth,height=0.62\textheight,keepaspectratio]{figs_deck/fig_senat_types.png}
    \end{column}
  \end{columns}
  \vspace{2mm}
...
\begin{frame}{1b · Sénat --- distinguer page web et papier scanné}
  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}\centering
      \fcolorbox{selec}{white}{\clickzoom{senate_digital_1}{\includegraphics[width=0.72\linewidth,height=0.42\textheight,keepaspectratio]{figs_deck/senate_digital.png}}}\\[1.5mm]
      \badge{selec}{page web --- 1\,780}\\[0.8mm]
      {\scriptsize table déjà propre, lue directement}
    \end{column}
    \begin{column}{0.46\textwidth}\centering
      \fcolorbox{socr}{white}{\clickzoom{senat_papier_droit_1}{\includegraphics[width=0.52\linewidth,height=0.42\textheight,keepaspectratio]{figs_deck/senat_papier_droit.png}}}\\[1.5mm]
...
\begin{frame}{2b · Chambre · texte --- un PDF n'est pas un tableau}
  \begin{columns}[T]
    \begin{column}{0.40\textwidth}\centering
      \clickzoom{fig_ptr_multiligne}{\includegraphics[width=\linewidth,height=0.56\textheight,keepaspectratio]{figs_deck/fig_ptr_multiligne.png}}\\[0.5mm]
  ...
  \begin{columns}[c]
    \begin{column}{0.38\textwidth}\centering
      \begin{minipage}[t]{0.49\linewidth}\centering
        \fcolorbox{helec}{white}{\clickzoom{scan_full_droit}{\includegraphics[width=0.9\linewidth,keepaspectratio]{figs_deck/scan_full_droit.png}}}\\[0.6mm]
        {\scriptsize\textbf{tapé}}
      \end{minipage}\hfill
      \begin{minipage}[t]{0.49\linewidth}\centering
        \fcolorbox{hocr}{white}{\clickzoom{scan_full_manuscrit}{\includegraphics[width=0.9\linewidth,keepaspectratio]{figs_deck/scan_full_manuscrit.png}}}\\[0.6mm]
...
\begin{frame}{2c · Sénat · texte --- la donnée arrive déjà en table}
  \begin{columns}[c]
    \begin{column}{0.52\textwidth}\centering
      \fcolorbox{selec}{white}{\clickzoom{senate_digital_2}{\includegraphics[width=0.96\linewidth,height=0.46\textheight,keepaspectratio]{figs_deck/senate_digital.png}}}
    \end{column}
...
\begin{frame}{2c · Sénat · image --- le papier, trois écritures}
  ...
  \begin{columns}[T]
    \begin{column}{0.30\textwidth}\centering
      \parbox[t][37mm][c]{\linewidth}{\centering\fcolorbox{socr}{white}{\clickzoom{sp_tape}{\includegraphics[width=0.8\linewidth,height=35mm,keepaspectratio]{figs_deck/senat_papier_droit.png}}}}\\[1.5mm]
      {\scriptsize\textbf{tapé}}\\[0.4mm]{\textbf{254}~{\scriptsize\color{black!55}69\,\%}}
    \end{column}
    \begin{column}{0.30\textwidth}\centering
      \parbox[t][37mm][c]{\linewidth}{\centering\fcolorbox{socr}{white}{\clickzoom{sp_manu}{\includegraphics[width=0.8\linewidth,height=35mm,keepaspectratio]{figs_deck/senat_papier_manuscrit.png}}}}\\[1.5mm]
      {\scriptsize\textbf{manuscrit}}\\[0.4mm]{\textbf{11}~{\scriptsize\color{black!55}3\,\%}}
    \end{column}
    \begin{column}{0.30\textwidth}\centering
      \parbox[t][37mm][c]{\linewidth}{\centering\fcolorbox{socr}{white}{\clickzoom{sp_annexe}{\includegraphics[width=0.8\linewidth,height=35mm,keepaspectratio]{figs_deck/senat_papier_annexe_v.png}}}}\\[1.5mm]
...
\begin{frame}{2c · Sénat · image --- Quiver ne peut rien vérifier, donc on garde tout}
  \begin{columns}[c]
    \begin{column}{0.42\textwidth}\centering
      \fcolorbox{black!30}{white}{\clickzoom{senat_papier_droit_2}{\includegraphics[width=0.92\linewidth,height=0.60\textheight,keepaspectratio]{figs_deck/senat_papier_droit.png}}}\\[0.6mm]
...
\begin{frame}{7a · Entonnoir des lignes --- de 169\,000 à 134\,464 : on ne retire que l'avéré inutilisable}
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figs_deck/entonnoir_backtest.png}
    \end{column}
...
\begin{frame}{7b · Entonnoir des symboles --- 118\,029 trades ont un prix fiable ($\approx$88\,\% des 134\,464)}
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figs_deck/entonnoir_tickers.png}
    \end{column}
    \begin{column}{0.40\textwidth}
...
\begin{frame}{9 · Quiver --- la corroboration monte avec le temps : peu de vérité-terrain avant 2017}
  \begin{columns}[c]
    \begin{column}{0.58\textwidth}\centering
      \includegraphics[width=\linewidth]{figs_deck/corroboration_par_annee.png}\\[0.5mm]
...
\begin{frame}{Et souvent, c'est le conjoint qui passe l'ordre}
  \centering
  \includegraphics[width=0.95\textwidth,height=0.56\textheight,keepaspectratio]{figs_deck/A3_proprietaires.png}\\[2mm]
...
\begin{frame}{Les montants sont déclarés par fourchettes}
  ...
  \centering
  \includegraphics[width=0.95\textwidth,height=0.54\textheight,keepaspectratio]{figs_deck/A4_tailles.png}\\[2mm]
...
\begin{frame}{Ils déclarent en moyenne 27 jours après le trade}
  ...
  \centering
  \includegraphics[width=0.95\textwidth,height=0.52\textheight,keepaspectratio]{figs_deck/A5_delai.png}\\[2mm]
...
\end{column}
    \begin{column}{0.54\textwidth}\centering
      \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{figs_deck/B1_vt_membre.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Le rendement « en parts » : un apport n'est jamais une performance}
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.54\textwidth}\centering
      \includegraphics[width=\linewidth,height=0.64\textheight,keepaspectratio]{figs_deck/B2_spaghetti.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Chacun a ses secteurs de prédilection}
  \begin{columns}[T]
    ...
    \begin{column}{0.68\textwidth}\centering
      \includegraphics[width=\linewidth,height=0.70\textheight,keepaspectratio]{figs_deck/B6_secteurs.png}
    \end{column}
  \end{columns}
  \vspace{1mm}
...
\begin{frame}{La porte d'entrée : 223 membres sur 266 sont jugeables}
  ...
  \includegraphics[height=0.62\textheight]{figs_deck/fig_05b_eligibilite.png}\\[1.5mm]
...
\begin{frame}{Deux mètres pour « battre le SPY » : l'écart brut (IR) ou l'alpha ajusté du $\beta$}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}\centering
      \includegraphics[width=0.93\linewidth]{figs_deck/fig_05b_regression_demo.png}\\[0.5mm]
...
\begin{frame}{La mesure ne trouve presque rien : 20 « gagnants », 12 après le $\beta$, 11 par hasard}
  ...
  \includegraphics[height=0.54\textheight]{figs_deck/fig_05b_hist_t.png}\\[2mm]
...
\begin{frame}{Test 1 · qui copier : le top-$K$, sans jamais regarder le futur}
  \begin{columns}[T]
    ...
    \begin{column}{0.47\textwidth}\centering
      \includegraphics[width=\linewidth]{figs_deck/fig_05b_nsig_par_an.png}\\[1mm]
...
\begin{frame}{Test 1 · ce qu'on observe : +3,1 \%/an, mais porté par le $\beta$}
  ...
  \includegraphics[height=0.40\textheight]{figs_deck/fig_05b_nav_top4.png}\\[2mm]
...
\begin{frame}{Tests 2 \& 3 · combien copier ($K$), et à quelle cadence}
  ...
  \includegraphics[width=0.55\textwidth]{figs_deck/fig_05b_k_et_cadence.png}\\[1.5mm]
...
\begin{frame}{Test 4 · comment répartir le capital entre les copiés}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.51\textwidth}\centering
      \includegraphics[width=0.92\linewidth]{figs_deck/fig_05b_ponderations.png}
    \end{column}
  \end{columns}
  \vspace{0.5mm}
  \centering
...
\begin{frame}{Test 5 · changer la règle de sélection : le Sharpe brut}
  ...
  \includegraphics[height=0.48\textheight]{figs_deck/fig_05b_hist_sharpe.png}\\[1.5mm]
...
\begin{frame}{Test 5 · ce qu'on observe : le $t$ plafonne à 1,22, loin du seuil}
  \centering
  \includegraphics[width=0.62\textwidth]{figs_deck/fig_05b_balayage_k.png}\\[2mm]
...
\begin{frame}{1 · Le catalogue --- à quoi correspond chaque type}
  ...
  \begin{columns}[T]
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/10059952.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=29mm]{figs_deck/ftype_o.png}}}\\[0.8mm]
      {\footnotesize\textbf{O — Annual}}\\{\scriptsize bilan annuel · \textbf{4\,626}}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/10056211.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=29mm]{figs_deck/ftype_c.png}}}\\[0.8mm]
      {\footnotesize\textbf{C — Candidate}}\\{\scriptsize candidat · \textbf{10\,129}}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/10062638.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=29mm]{figs_deck/ftype_h.png}}}\\[0.8mm]
      {\footnotesize\textbf{H — New Filer}}\\{\scriptsize 1\iere{} déclaration · \textbf{395}}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/10050798.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=29mm]{figs_deck/ftype_t.png}}}\\[0.8mm]
      {\footnotesize\textbf{T — Termination}}\\{\scriptsize départ · \textbf{394}}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/10062190.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=29mm]{figs_deck/ftype_a.png}}}\\[0.8mm]
...
\begin{frame}{1 · Le catalogue --- les types sans transaction}
  ...
  \begin{columns}[T]
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/30019473.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=21mm]{figs_deck/ftype_x.png}}}\\[0.6mm]
      {\scriptsize\textbf{X — Extension}\\demande de délai}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/40003491.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=21mm]{figs_deck/ftype_d.png}}}\\[0.6mm]
      {\scriptsize\textbf{D — Campaign Notice}\\« < 5\,000 \$ »}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/8219940.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=21mm]{figs_deck/ftype_w.png}}}\\[0.6mm]
      {\scriptsize\textbf{W — idem, papier}\\(ou retrait)}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/8219324.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=21mm]{figs_deck/ftype_e.png}}}\\[0.6mm]
      {\scriptsize\textbf{E — Exemption}\\départ, poste fédéral}
    \end{column}
    \begin{column}{0.19\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/8219737.pdf}{\fcolorbox{black!30}{white}{\includegraphics[height=21mm]{figs_deck/ftype_g.png}}}\\[0.6mm]
  ...
  \begin{columns}[c]
    \begin{column}{0.14\textwidth}\centering
      \href{https://disclosures-clerk.house.gov/public_disc/financial-pdfs/2023/8219364.pdf}{\fcolorbox{alertred}{white}{\includegraphics[height=20mm]{figs_deck/ftype_b.png}}}
    \end{column}
...
\begin{frame}{1 · Le catalogue --- la vie déclarative d'un élu}
  \centering
  \includegraphics[width=0.84\textwidth]{figs_deck/fig_house_loi_cycle.png}\\[1mm]
...
\begin{frame}{1 · Le catalogue --- le même formulaire, des sections en commun}
  ...
  \includegraphics[height=0.54\textheight]{figs_deck/fig_sections_matrix.png}\\[0.5mm]
...
\begin{frame}{4 · Vérifier --- le résultat : 87,8\,\% expliquées, 3,3\,\% non}
  ...
  \begin{columns}[c]
    \begin{column}{0.44\textwidth}\centering
      \includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{figs_deck/fig_v1_coherence.png}\\[0.5mm]
...
\begin{frame}{4 · Vérifier --- deux cas qui éclairent}
  \begin{columns}[c]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}\centering
      \fcolorbox{black!25}{white}{\includegraphics[width=0.9\linewidth,height=34mm,keepaspectratio]{figs_deck/fig_pelosi_schedb.png}}\\[1mm]
...
\begin{frame}{A1 --- Le document lisible : un PTR électronique}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}\centering
      \fcolorbox{helec}{white}{\clickzoom{fig_ptr_digital}{\includegraphics[width=0.92\linewidth,height=64mm,keepaspectratio]{figs_deck/fig_ptr_digital.png}}}\\[0.5mm]
...
\begin{frame}{A2 --- Le portail du Sénat : ce que rend la recherche}
  \centering
  \fcolorbox{black!25}{white}{\clickzoom{site_senate_results}{\includegraphics[width=0.78\textwidth,height=0.60\textheight,keepaspectratio]{figs_deck/site_senate_results.png}}}\\[1.5mm]
...
\begin{frame}{A3 --- Le même formulaire, des sections en commun}
  \centering
  \includegraphics[height=0.61\textheight]{figs_deck/fig_sections_matrix.png}\\[0.5mm]
...
\begin{frame}{Le shrinkage répare l'estimateur de $\Sigma$ — pas la stratégie}
  ...
  \includegraphics[height=0.40\textheight]{figs_deck/fig_05b_gmv_ledoitwolf.png}\\[1.5mm]
...
\begin{frame}{La contre-preuve point par point : la queue droite de l'IR, c'était du $\beta$}
  \centering
  \includegraphics[height=0.63\textheight]{figs_deck/fig_05b_ir_vs_appraisal.png}\\[1mm]
...
% Figures : docs/figs_deck/fig_09_*.png (régénérées du notebook, fidèles aux inline)
% ══════════════════════════════════════════════════════════════════
...
\begin{frame}{Rien n'entre dans les tables sans passer l'entonnoir}
  ...
  \includegraphics[width=0.80\textwidth,height=0.52\textheight,keepaspectratio]{figs_deck/fig_09_entonnoir.png}\\[2mm]
...
\begin{frame}{La fiche (1/6) — identité : chaque élu a la sienne, suivons-en une}
  ...
  \includegraphics[width=0.78\textwidth,height=0.52\textheight,keepaspectratio]{figs_deck/fig_09_identite.png}\\[2mm]
...
\begin{frame}{La fiche (2/6) — activité : tout tient en une figure}
  ...
  \includegraphics[height=0.52\textheight,width=0.9\textwidth,keepaspectratio]{figs_deck/fig_09_activite.png}\\[2mm]
...
\begin{frame}{La fiche (3/6) — portefeuille : reconstruit jour après jour}
  ...
  \includegraphics[height=0.46\textheight,width=0.9\textwidth,keepaspectratio]{figs_deck/fig_09_portefeuille.png}\\[2mm]
...
\begin{frame}{La fiche (4/6) — durées : la moitié vit plus de 910 jours}
  ...
  \includegraphics[width=0.72\textwidth,height=0.46\textheight,keepaspectratio]{figs_deck/fig_09_km.png}\\[2mm]
...
\begin{frame}{La fiche (5/6) — risque \& perf : devant le SPY, sans certitude}
  ...
  \includegraphics[height=0.40\textheight,width=0.9\textwidth,keepaspectratio]{figs_deck/fig_09_nav.png}\\[2mm]
...
\begin{frame}{La fiche (6/6) — comportement : trois signaux, trois colonnes}
  ...
  \includegraphics[width=0.64\textwidth,height=0.40\textheight,keepaspectratio]{figs_deck/fig_09_comportement.png}\\[2mm]
...
\begin{frame}{Le duel vs SPY, année par année : le panel annuel}
  ...
  \includegraphics[width=0.76\textwidth,height=0.52\textheight,keepaspectratio]{figs_deck/fig_09_annees.png}\\[2mm]
...
\begin{frame}{Le même récit, vu du ticker : NVDA sous l'œil du Congrès}
  ...
  \includegraphics[height=0.44\textheight,width=0.9\textwidth,keepaspectratio]{figs_deck/fig_09_ticker_nvda.png}\\[2mm]
...
\begin{frame}{D'une élue aux 223 : les distributions derrière les fiches}
  ...
  \includegraphics[width=0.84\textwidth,height=0.52\textheight,keepaspectratio]{figs_deck/fig_09_distributions.png}\\[2mm]
...
\begin{frame}{Le verdict, trade par trade — 58\,926 achats notés face au SPY}
  ...
  \includegraphics[width=0.60\textwidth,height=0.30\textheight,keepaspectratio]{figs_deck/fig_09_exces.png}\\[1.5mm]
...
\zoomframe{scan_full_droit}{figs_deck/scan_full_droit.png}
\zoomframe{scan_full_manuscrit}{figs_deck/scan_full_manuscrit.png}
\zoomframe{site_house_clerk}{figs_deck/site_house_clerk.png}
\zoomframe{fichier_index_xml}{figs_deck/fichier_index_xml.png}
\zoomframe{house_digital}{figs_deck/house_digital.png}
\zoomframe{house_ocr}{figs_deck/house_ocr.png}
\zoomframe{site_senate_form}{figs_deck/site_senate_form.png}
\zoomframe{senate_digital_1}{figs_deck/senate_digital.png}
\zoomframe{senat_papier_droit_1}{figs_deck/senat_papier_droit.png}
\zoomframe{fig_ptr_multiligne}{figs_deck/fig_ptr_multiligne.png}
\zoomframe{senate_digital_2}{figs_deck/senate_digital.png}
\zoomframe{senat_papier_droit_2}{figs_deck/senat_papier_droit.png}
\zoomframe{sp_tape}{figs_deck/senat_papier_droit.png}
\zoomframe{sp_manu}{figs_deck/senat_papier_manuscrit.png}
\zoomframe{sp_annexe}{figs_deck/senat_papier_annexe_v.png}
\zoomframe{fig_pelosi_schedb}{figs_deck/fig_pelosi_schedb.png}
\zoomframe{fig_ptr_digital}{figs_deck/fig_ptr_digital.png}
\zoomframe{site_senate_results}{figs_deck/site_senate_results.png}
\zoomframe{ftype_x}{figs_deck/ftype_x.png}
\zoomframe{ftype_d}{figs_deck/ftype_d.png}
\zoomframe{ftype_w}{figs_deck/ftype_w.png}
\zoomframe{ftype_e}{figs_deck/ftype_e.png}
\zoomframe{ftype_g}{figs_deck/ftype_g.png}
\zoomframe{ftype_b}{figs_deck/ftype_b.png}
