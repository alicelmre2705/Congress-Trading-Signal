...
% du rapport qualité RAPPORT_QUALITE.md (python -m common.quality, offline)
...
(\S{}\ref{sec:quiver}).
\end{itemize}
Le détail par an et par champ figure dans \co{RAPPORT_QUALITE.md}~; l'essentiel en
...
\begin{subfigure}[t]{0.46\textwidth}\centering
  \includegraphics[width=\linewidth]{png/quality/delai_divulgation.png}
...
\end{subfigure}\hfill
\begin{subfigure}[t]{0.46\textwidth}\centering
  \includegraphics[width=\linewidth]{png/quality/top_deposants.png}
  \caption{Top~12 déposants (nombre de transactions).}
\end{subfigure}

\vspace{0.5em}
\begin{subfigure}[t]{0.46\textwidth}\centering
  \includegraphics[width=\linewidth]{png/quality/mix_operations_par_corpus.png}
  \caption{Sens des opérations, \emph{par sous-corpus}.}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.46\textwidth}\centering
  \includegraphics[width=\linewidth]{png/quality/mix_actifs_par_corpus.png}
  \caption{Mix de types d'actifs, \emph{par sous-corpus}.}
\end{subfigure}

\vspace{0.5em}
\begin{subfigure}[t]{0.46\textwidth}\centering
  \includegraphics[width=\linewidth]{png/quality/volume_par_secteur.png}
  \caption{Volume par secteur GICS (top 12, ensemble).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.40\textwidth}\centering
  \includegraphics[width=\linewidth]{png/quality/concentration_lorenz.png}
...
\co{data/quiver_validation/}, pas des taux d'erreur).
...
\includegraphics[height=7cm]{png/figs_deck/house_digital.png}\\[3pt]
...
\end{minipage}\hfill
\begin{minipage}[t]{0.47\textwidth}\centering
\includegraphics[height=7cm]{png/figs_deck/house_ocr.png}\\[3pt]
...
\vspace{12pt}
\begin{minipage}[t]{0.47\textwidth}\centering
\includegraphics[width=\linewidth]{png/figs_deck/senate_digital.png}\\[3pt]
...
\end{minipage}\hfill
\begin{minipage}[t]{0.47\textwidth}\centering
\includegraphics[width=\linewidth]{png/figs_deck/senate_ocr.png}\\[3pt]
...
est le rapport qualité \co{RAPPORT_QUALITE.md}, dont cette annexe ne retient que l'essentiel.
