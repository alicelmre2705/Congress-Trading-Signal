...
|---|---|---|
| `transactions_brut_2014_2026.csv` | 169 000 × 43 | **la brute** : tout le corpus unique, avec pour chaque ligne écartée son étape et son motif (`exclusion_etape`, `exclusion_motif`) — rien d'écarté en silence |
| `transactions_backtest_2014_2026.csv` | 118 316 × 41 | **la clean** : la table de recherche canonique (celle que `02_recherche_backtest/` consomme) |
